...
\subfloat[Left panel]{\includegraphics[scale=0.2,page=1]{figures}

}\hfill{}\subfloat[Right panel]{\includegraphics[scale=0.2,page=2]{figures}
...
Note that the *.bib file must be remove once the *.bbl file has become
available.
